package com.ccp.decorators.test;
...
public class CcpTestJsonRepresentation {
	...
	public void copyIfNotContainsTest() {
       ...
       System.out.println(objJson.copyIfNotContains("nome","nomeCopiado"));//O valor do campo nome não foi colado em nomeCopiado
    }
	
	//VERIFICAR SE MÉTODO ESTÁ FUNCIONANDO
	@Test
	public void putIfNotContainsTest() {
	   String json = "{'valor': ''}";//TALVEZ ELE IDENTIFIQUE O CAMPO EM BRANCO COMO ALGO, COLOCAR A PALAVRA 'undefined' TAMBÉM NÃO FUNCIONPU
	   
       CcpJsonRepresentation objJson = new CcpJsonRepresentation(json);
       
       System.out.println(objJson.putIfNotContains("valor", "---"));
	...
	public void toInputStreamTest() {
		...
		System.out.println(json.toInputStream());
	}
	...
	public void equalsTest() {
		...
		int hash2 = json2.hashCode();
		
		System.out.println(json.equals(hash2));
	}
	...
	public void getAsTextDecoratorListTest() {
		...
		System.out.println(json.getAsTextDecoratorList(registro).toString());
		System.out.println("***");
